...
/*
   Experimental Extension of http grammar to support http 1/1
*/


:- module(http_grammar_v11).
...
requ_head(acceptLanguage) --> ["Accept"], [-], [language], [:], 
	language.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
requ_head(sec_fetch_dest) --> ["Sec"], [-], ["Fetch"], [-], ["Dest"], [:], dest.
requ_head(sec_fetch_mode) --> ["Sec"], [-], ["Fetch"], [-], ["Mode"], [:], mode.
requ_head(sec_fetch_user) --> ["Sec"], [-], ["Fetch"], [-], ["User"], [:], sec_user.
requ_head(upgrade_insecure_request) --> ["Upgrade"], [-], ["Insecure"], [-], ["Requests"], [:], uir.
%requ_head(sec_fetch_site) --> ["Sec"], [-], ["Fetch"], [-], ["Site"], [:], site.
%requ_head(sec_ch_ua) --> ["sec"], [-], ["ch"], [-], ["ua"], [:], secchua.
%requ_head(cache_control) --> ["Cache"], [-], ["Control"], [:], ch_crtl(Directives).
%requ_head(sec_ch_ua_platform) --> ["sec"], [-], ["ch"], [-], ["ua"], [-], ["platform"], [:], platform.
%requ_head(sec_ch_ua_mobile) --> ["Sec"], [-], ["CH"], [-], ["UA"], [-], ["Mobile"], [:], mobile.
...
resp_head(retryAfter) --> ["Retry"], [-], [after], [:], retry_after.
%resp_head(cache_control) --> ["Cache"], [-], ["Control"], [:], ch_crtl(Directives).
...
%%% newly added
obje_head(vary) --> ["Vary"], [:], rest.
obje_head(xContentTypeOptions(nosniff)) --> ["X"],[-],["Content"],[-],["Type"],[-],["Options"], [:], [nosniff].
obje_head(xFrameOptions) --> ["X"],[-],["Frame"],[-],["Options"], [:], rest.
